...
var sample = (function(){
    ...
    sampleRedis.init = function(redis){
        ...
        client.hset('REALTIME', 'DEVICE1', 
                    JSON.stringify(DEVICE1), client.print);
        client.hset('REALTIME', 'DEVICE2', 
                    JSON.stringify(DEVICE2), client.print);
        client.hset('REALTIME', 'DEVICE3', 
                    JSON.stringify(DEVICE3), client.print);
    ...
    sampleRedis.update = function(id, sentence){
        ...
        client.hget('REALTIME', id, function(err, result){
            if(err) throw err;
            ...
            // Set
            client.hset('REALTIME', id, 
                        JSON.stringify(device), client.print);
